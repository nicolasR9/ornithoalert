...
public class Main {
    ...
    private static final Species[] SPECIES = {Species.GELBSCHNABELTAUCHER};
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Species species: SPECIES) {
            ...
            String url = URL_TEMPLATE.replaceAll("%%DATE_FROM%%", FORMATTER.format(FROM));
            url = url.replaceAll("%%DATE_TO%%", FORMATTER.format(TO));
