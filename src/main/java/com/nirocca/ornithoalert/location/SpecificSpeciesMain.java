...
import static com.nirocca.ornithoalert.Species.ZWERGSCHNAEPFE;
...
public class SpecificSpeciesMain {
    ...
    private static final Species[] SPECIES = {ZWERGSCHNAEPFE};
