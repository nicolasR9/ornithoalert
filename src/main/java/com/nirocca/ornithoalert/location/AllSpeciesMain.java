...
public class AllSpeciesMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int year : yearsToCheck) {
            ...
            sightings.addAll(com.nirocca.ornithoalert.Main.calcSightings(url, SortBy.TIME, false));
        }
