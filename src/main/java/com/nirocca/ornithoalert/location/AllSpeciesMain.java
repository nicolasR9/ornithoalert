...
public class AllSpeciesMain {
    ...
    private static final String URL_TEMPLATE = "https://www.ornitho.de/index.php?m_id=94&p_c=2&p_cc=202&sp_tg=1&sp_DFrom=24.08.2022&sp_DTo=24.08.2022&sp_DSeasonFromDay=1&sp_DSeasonFromMonth=1&sp_DSeasonToDay=31&sp_DSeasonToMonth=12&sp_DChoice=offset&sp_DOffset=21&speciesFilter=&sp_S=292&sp_SChoice=category&sp_Cat%5Bnever%5D=1&sp_Cat%5Bveryrare%5D=1&sp_Cat%5Brare%5D=1&sp_Cat%5Bunusual%5D=1&sp_Cat%5Bescaped%5D=1&sp_Cat%5Bcommon%5D=1&sp_Family=1&sp_cC=&sp_cCO=001100000000010000000000000&sp_CommuneCounty=356&sp_Commune=12332&sp_Info=&sp_P=0&sp_PChoice=polygon&sp_Polygon=POLYGON%28%2813.257316044376903+54.17943821122962%2C13.336966922997073+54.053868234850704%2C13.538154056063538+54.082879690060835%2C13.42073767464932+54.200329568449334%2C13.257316044376903+54.17943821122962%29%29&sp_PolygonSaveName=&sp_PolygonSaveRestoreID=&sp_AltitudeFrom=-19&sp_AltitudeTo=2962&sp_CommentValue=&sp_OnlyAH=0&sp_Ats=-00000&sp_project=&sp_OnlyStoc=&sp_frmListType=&sp_FChoice=list&sp_FDisplay=DATE_PLACE_SPECIES&sp_DFormat=DESC&sp_FOrderListSpecies=ALPHA&sp_FListSpeciesChoice=DATA&sp_DateSynth=24.08.2022&sp_FOrderSynth=ALPHA&sp_FGraphChoice=DATA&sp_FGraphFormat=auto&sp_FAltScale=250&sp_FAltChoice=DATA&sp_FMapFormat=none&submit=Abfrage+starten";
    private static final int[] yearsToCheck = {2022};
    private static final String FROM_DATE = "02.08.";
    private static final String TO_DATE = "24.08.";
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int year : yearsToCheck) {
            ...
            sightings.addAll(com.nirocca.ornithoalert.Main.calcSightings(url, SortBy.TIME, FilterMySightedSpecies.ONLY_THIS_YEAR));
        }
